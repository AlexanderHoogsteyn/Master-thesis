...
for feeder_id in included_feeders:
    for rep in np.arange(reps):
        ...
        phase_identification.load_correlation_enhanced_tuning(nb_salient_components=nb_salient_components, nb_assignments=nb_assignments, salient_components=salient_components, length=base_length)
...
for feeder_id in included_feeders:
    for rep in np.arange(reps):
        ...
        phase_identification.load_correlation_enhanced_tuning(nb_salient_components=nb_salient_components, nb_assignments=nb_assignments, salient_components=salient_components, length=length)
        acc = acc + phase_identification.accuracy()
