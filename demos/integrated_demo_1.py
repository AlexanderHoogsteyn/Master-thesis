...
for feeder_id in included_feeders:
    ...
    feeder.voltage_assisted_load_correlation(sal_treshold_load=1, sal_treshold_volt=0.0, corr_treshold=2, volt_assist= volt_assist, length=length,salient_components=4)
